...
def main():
    ...
    model.load_state_dict(torch.load('/home/canhdx/workspace/TSAN-brain-age-estimation/pretrained_model/ScaleDenseScaleDense_best_model.pth.tar')['state_dict'])
...
def test(valid_loader, model, criterion, device
        ...
        , figure=True, figure_name='True_age_and_predicted_age.png'):
