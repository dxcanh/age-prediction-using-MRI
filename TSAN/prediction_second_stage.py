...
from utils.discretize_age import discretize_age
...
def main():
    ...
    model_first_stage.load_state_dict(torch.load("/home/canhdx/workspace/TSAN-brain-age-estimation/pretrained_model/ScaleDenseScaleDense_best_model.pth.tar")['state_dict'])
    model_first_stage.eval()

    # ======== load trained parameters ======== #

    model = nn.DataParallel(model).to(device)
    model.load_state_dict(torch.load('/home/canhdx/workspace/TSAN-brain-age-estimation/pretrained_model/second_stage_test/ScaleDense_best_model.pth.tar')['state_dict'])
