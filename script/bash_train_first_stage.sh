...
lbd=10
beta=1
save_path=/home/canhdx/workspace/TSAN-brain-age-estimation/pretrained_model/ScaleDense
...
CUDA_VISIBLE_DEVICES=1     python /home/canhdx/workspace/TSAN-brain-age-estimation/TSAN/train_first_stage.py       \
