...
def main(res):
    ...
    # Khởi tạo WandB
    wandb.init(project="age-prediction-second-stage", config=vars(opt))
    ...
    model_first_stage.load_state_dict(
        torch.load("/home/canhdx/workspace/TSAN-brain-age-estimation/pretrained_model/ScaleDenseScaleDense_best_model.pth.tar")['state_dict']
    )
